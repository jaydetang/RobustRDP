...
if __name__ == "__main__":
    # 将 ./raw_val_data/RobustRDP_test中的原始数据进行转换，对图片进行缩放，转换为RobustRDP的格式
    gen_processed_val_data('./raw_val_data/RobustRDP_test/labels_eval', 
                    './raw_val_data/RobustRDP_test/merged_eval_output.json')
    
    down_sample_main("./raw_val_data/RobustRDP_test/images_eval", './raw_val_data/RobustRDP_test/merged_eval_output.json', mode="dev")